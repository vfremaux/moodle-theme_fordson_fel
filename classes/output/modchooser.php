...
class modchooser extends chooser {
    ...
    public function __construct($course, $modules) {
        global $PAGE;
        // This copy of the modchooser is modified for Hillbrook Anglican School theme fordson_fel
        // It contains functionality to output a section of modules defined as "commonly used" in the theme_fordson_fel settings
        $this->course = $course;

        $sections = [];
        $context = context_course::instance($course->id);
        $showonlycustom = get_config('theme_fordson_fel', 'showonlycustomactivities');
        $showallmanager = get_config('theme_fordson_fel', 'showalltomanager');
        ...
        $commonlyused = array();
        $commonlyusedsetting = get_config('theme_fordson_fel', 'commonlyused');
