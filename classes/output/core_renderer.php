...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    public function page_heading_button() {
        ...
        if ($COURSE->id > SITEID) {
            ...
            if (has_capability('moodle/course:manageactivities', $context) && $COURSE->visible == 0) {
                ...
                $str .= get_string('hiddencourse', 'theme_fordson_fel').'&nbsp;&nbsp;&nbsp; <a class="open-course-button btn btn-success edit-btn" href="'.$coursepublishurl.'">'.get_string('publish', 'theme_fordson_fel').'</a>';
            }
        }
        return $str;
    }
    ...
    public function fordson_fel_custom_menu() {
        ...
        if (isloggedin() && !isguestuser() && $hasdisplaymycourses) {
            ...
            if ($mycoursetitle == 'module') {
                $branchtitle = get_string('mymodules', 'theme_fordson_fel');
                $thisbranchtitle = get_string('thismymodules', 'theme_fordson_fel');
                $homebranchtitle = get_string('homemymodules', 'theme_fordson_fel');
            } else if ($mycoursetitle == 'unit') {
                $branchtitle = get_string('myunits', 'theme_fordson_fel');
                $thisbranchtitle = get_string('thismyunits', 'theme_fordson_fel');
                $homebranchtitle = get_string('homemyunits', 'theme_fordson_fel');
            } else if ($mycoursetitle == 'class') {
                $branchtitle = get_string('myclasses', 'theme_fordson_fel');
                $thisbranchtitle = get_string('thismyclasses', 'theme_fordson_fel');
                $homebranchtitle = get_string('homemyclasses', 'theme_fordson_fel');
            } else if ($mycoursetitle == 'training') {
                $branchtitle = get_string('mytraining', 'theme_fordson_fel');
                $thisbranchtitle = get_string('thismytraining', 'theme_fordson_fel');
                $homebranchtitle = get_string('homemytraining', 'theme_fordson_fel');
            } else if ($mycoursetitle == 'pd') {
                $branchtitle = get_string('myprofessionaldevelopment', 'theme_fordson_fel');
                $thisbranchtitle = get_string('thismyprofessionaldevelopment', 'theme_fordson_fel');
                $homebranchtitle = get_string('homemyprofessionaldevelopment', 'theme_fordson_fel');
            } else if ($mycoursetitle == 'cred') {
                $branchtitle = get_string('mycred', 'theme_fordson_fel');
                $thisbranchtitle = get_string('thismycred', 'theme_fordson_fel');
                $homebranchtitle = get_string('homemycred', 'theme_fordson_fel');
            } else if ($mycoursetitle == 'plan') {
                $branchtitle = get_string('myplans', 'theme_fordson_fel');
                $thisbranchtitle = get_string('thismyplans', 'theme_fordson_fel');
                $homebranchtitle = get_string('homemyplans', 'theme_fordson_fel');
            } else if ($mycoursetitle == 'comp') {
                $branchtitle = get_string('mycomp', 'theme_fordson_fel');
                $thisbranchtitle = get_string('thismycomp', 'theme_fordson_fel');
                $homebranchtitle = get_string('homemycomp', 'theme_fordson_fel');
            } else if ($mycoursetitle == 'program') {
                $branchtitle = get_string('myprograms', 'theme_fordson_fel');
                $thisbranchtitle = get_string('thismyprograms', 'theme_fordson_fel');
                $homebranchtitle = get_string('homemyprograms', 'theme_fordson_fel');
            } else if ($mycoursetitle == 'lecture') {
                $branchtitle = get_string('mylectures', 'theme_fordson_fel');
                $thisbranchtitle = get_string('thismylectures', 'theme_fordson_fel');
                $homebranchtitle = get_string('homemylectures', 'theme_fordson_fel');
            } else if ($mycoursetitle == 'lesson') {
                $branchtitle = get_string('mylessons', 'theme_fordson_fel');
                $thisbranchtitle = get_string('thismylessons', 'theme_fordson_fel');
                $homebranchtitle = get_string('homemylessons', 'theme_fordson_fel');
            } else {
                $branchtitle = get_string('mycourses', 'theme_fordson_fel');
                $thisbranchtitle = get_string('thismycourses', 'theme_fordson_fel');
                $homebranchtitle = get_string('homemycourses', 'theme_fordson_fel');
            }
            ...
            if ($courses = enrol_get_my_courses(NULL, 'fullname ASC')) {
                ...
                $noenrolments = get_string('noenrolments', 'theme_fordson_fel');
    ...
    */
    ...
    protected function render_courseactivities_menu(custom_menu $menu) {
        ...
        foreach ($menu->get_children() as $item) {
            $context = $item->export_for_template($this);
            $content .= $this->render_from_template('theme_fordson_fel/activitygroups', $context);
        }
    ...
    public function courseactivities_menu() {
        ...
        if (isset($COURSE->id) && $COURSE->id > 1) {
            $branchtitle = get_string('courseactivities', 'theme_fordson_fel');
            $branchlabel = $branchtitle;
            $branchurl = new moodle_url('#');
            $branch = $menu->add($branchlabel, $branchurl, $branchtitle, 10002);

            $data = theme_fordson_fel_get_course_activities();
    ...
    public function social_icons() {
        ...
        return $this->render_from_template('theme_fordson_fel/socialicons', $socialcontext);
    }
    ...
    public function teacherdashmenu() {
        ...
        if (isloggedin() && ISSET($COURSE->id) && $COURSE->id > 1) {
            ...
            if (has_capability('moodle/course:viewhiddenactivities', $context)) {
                $togglebutton = get_string('coursemanagementbutton', 'theme_fordson_fel');
            } else {
                $togglebuttonstudent = get_string('studentdashbutton', 'theme_fordson_fel');
            }
        }
        ...
        return $this->render_from_template('theme_fordson_fel/teacherdashmenu', $dashmenu);
    }
    ...
    public function teacherdash() {
        ...
        $qbankdesc = get_string('qbank_desc', 'theme_fordson_fel');
        $badges = get_string('badges', 'theme_fordson_fel');
        $badgesdesc = get_string('badges_desc', 'theme_fordson_fel');
        $coursemanage = get_string('coursemanage', 'theme_fordson_fel');
        $coursemanagedesc = get_string('coursemanage_desc', 'theme_fordson_fel');
        ...
        $progresschart = $this->render_from_template('theme_fordson_fel/progress-chart', $progresschartcontext);
        ...
        $hascourseinfogroup = array(
            'title' => get_string('courseinfo', 'theme_fordson_fel') ,
            'icon' => 'map'
        );
        $summary = theme_fordson_fel_strip_html_tags($COURSE->summary);
        $summarytrim = theme_fordson_fel_course_trim_char($summary, 300);
        $courseinfo = array(
            array(
        ...
        $hascoursestaff = array(
            'title' => get_string('coursestaff', 'theme_fordson_fel') ,
            'icon' => 'users'
        );
        ...
        $activitylinkstitle = get_string('activitylinkstitle', 'theme_fordson_fel');
        $activitylinkstitle_desc = get_string('activitylinkstitle_desc', 'theme_fordson_fel');
        $mygradestext = get_string('mygradestext', 'theme_fordson_fel');
        $myprogresstext = get_string('myprogresstext', 'theme_fordson_fel');
