...
$url = new moodle_url('/theme/fordson_fel/themecopy.php');
$PAGE->set_url($url); // Defined here to avoid notices on errors etc.
$PAGE->set_heading(get_string('copytheme', 'theme_fordson_fel'));
...
$returnurl = new moodle_url('/admin/settings.php', array('section' => 'themesettingfordson_fel'));
