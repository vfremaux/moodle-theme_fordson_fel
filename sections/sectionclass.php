...
require_once($CFG->dirroot.'/theme/fordson_fel/sections/sectionclass_form.php');
...
$url = new moodle_url('/theme/fordson_fel/sections/sectionclass.php', array('id' => $sectionid, 'sr' => $sr));
$PAGE->set_url($url);
