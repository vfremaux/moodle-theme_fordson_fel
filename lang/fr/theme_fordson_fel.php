...
/**
 * Strings for component 'theme_fordson_fel', language 'fr', branch 'MOODLE_34_STABLE'
 *
...
$string['blockdisplay_on'] = 'Affichage Fordson FEL en trois colonnes';
$string['blockwidthfordson_fel'] = 'Largeur du bloc de colonne';
$string['blockwidthfordson_fel_desc'] = 'Ajuster la largeur du bloc de colonne.';
$string['blog'] = 'URL du blog';
$string['blog_desc'] = 'Saisir l\'URL du blog de votre institution (ex : http://dearbornschools.org)';
$string['bodybkg'] = 'Couleur d\'arrière-plan du corps';
$string['bodybkg_desc'] = 'Couleur principale de l\'arrière-plan.';
...
$string['brandorganization_desc'] = 'Nom de l\'organisation apparaissant dans le pied de page.';
$string['brandphone'] = 'Numéro de téléphone de l\'organisation';
$string['brandphone_desc'] = 'Numéro de téléphone apparaissant dans le pied de page.';
$string['brandemail'] = 'Courriel de l\'organisation';
$string['brandemail_desc'] = 'Adresse de courriel de l\'organisation apparaissant dans le pied de page.';
...
$string['brandprimaryalt'] = 'Couleur principale opposée';
$string['brandprimaryalt_desc'] = 'Il s\'agit de la couleur opposée à la couleur principale de votre charte graphique.';
...
$string['brandsecondaryalt_desc'] = 'Il s\'agit de la couleur opposée à la oculeur alternative de votre charte graphique.';
...
$string['comingfrom'] = 'Provient de : {$a}';
...
* fordson_fel > Paramètres d\'image personnalisée > L\'image de connexion par défaut peut être utilisée pour modifier l\'image d\'arrière-plan de la page de connexion. <br>
* fordson_fel > Zones de contenu > La page d\'accueil peut être utilisée pour sélectionner une option en haut de la page. </b>';
...
$string['drawerbkg'] = 'Couleur d\'arrière-plan du tiroir latéral';
$string['drawerbkg_desc'] = 'Il s\'agit de la couleur de fond utilisée par le menu glissant sur le coté gauche de la page.';
$string['drawerfg'] = 'Couleur de d\'avant-plan du tiroir latéral';
$string['drawerfg_desc'] = 'Il s\'agit de la couleur de texte utilisée par le menu glissant sur le coté gauche de la page.';
...
$string['enhancedmydashboard_desc'] = 'En activiant cette option, vous rajouterez au tableau de bord toutes les fonctionnalités Fordson telles que le formulaire d\'inscription rapide, la possibilité de masquer les blocs, les icônes de navigation, un texte personnalisé, un carrousel d\'images, et bien plus.';
...
$string['facebook_desc'] = 'Saisir l\'URL de votre page Facebook (ex : http://www.facebook.com/).';
$string['favicon'] = 'Favicon';
$string['favicon_desc'] = 'Changez le favicon pour fordson_fel. Les images avec un fond transparent et une hauteur de 32px fonctionneront mieux. Types autorisés : PNG, JPG, ICO';
...
$string['footerfg'] = 'Couleur d\'avant-plan du pied de page';
$string['footerfg_desc'] = 'La couleur de texte du pied de page';
...
$string['generalcontentinfo_desc'] = 'Les options ci-dessous vous permettent de personnaliser la façon dont le contenu est affiché et d\'activer des fonctionnalités supplémentaires pour fordson_fel.';
...
$string['learningcontentpadding_desc'] = 'Cette option contrôle l\'espacement entre le haut de la page et le contenu du cours. généralement, vous voulez que la valeur de cette option soit inférieure à la hauteur de l\'image du header';
...
$string['marketingbuttontext_desc'] = 'Texte à inscrire sur le bouton.';
$string['marketingbuttonurl'] = 'URL du lien';
$string['marketingbuttonurl_desc'] = 'URL vers laquelle le bouton redirigera';
$string['marketingcontent'] = 'Contenu';
$string['marketingcontent_desc'] = 'Texte à afficher dans l\'annonce. Gardez ce texte court et attractif pour une meilleure accroche.';
$string['marketing_desc'] = 'Ce thème permet d\'ajouter jusqu\'à trois « annonces » marketing ou « publicitaires » sous le diaporama. Cela permet de mettre en valeur les informations principales pour vos usagers et de fournir les liens correspondants.';
...
$string['marketingheight_desc'] = 'Si vous souhaitez utiliser des images dans les annonces de la page d\'accueil vous pouvez fixer leur hauteur grâce à cette option.';
$string['marketingicon'] = 'Lien de l\'icône';
$string['marketingicon_desc'] = 'Nom de l\'icône que vous souhaitez utiliser pour les boutons des annonces de la page d\'accueil. Vous trouverez la liste des icônes disponibles  <a href="http://fortawesome.github.io/Font-Awesome/cheatsheet/" target="_new">ici</a>. Il vous suffit de saisir le texte qui suit « fa- ». Par exemple, pour avoir « fa-star », vous choisissez « star ».';
...
$string['marketinginfo_desc'] = 'Paramétrez les options des vos annonces de page d\'accueil. Vous devez avoir un titre pour que l\'annonce apparaisse. Les titres activent/désactivent les différentes annonces de la page d\'accueil.';
...
$string['marketingtitle_desc'] = 'Titre de cette annonce de la page d\'accueil. Le titre doit être présent pour que l\'annonce s\'affiche sur la page d\'accueil.';
$string['marketingurltarget'] = 'Cible du lien';
$string['marketingurltarget_desc'] = 'Choisir comment ouvrir le lien';
...
$string['markettextbkg'] = 'Couleur de fond du texte des annonces de la page d\'accueil';
$string['markettextbkg_desc'] = 'Il s\'agit de la couleur de fond de la zone de texte des annonces de la page d\'accueil.';
...
$string['presetaslast'] = 'Preset en dernière position';
$string['presetaslast_desc'] = 'Si actif, la feuille de preset sera ajoutée en dernier après toutes les autres feuilles SCSS du theme. Sinon, elle sera ajoutée en premier comme réglage de "départ"';
...
$string['shownavdrawer_desc'] = 'fordson_fel a éliminé le recourt à la zone de navigation en utilisant un menu déroulant pour la navigation en cours. Si vous devez utiliser la zone de navigation, vous pouvez cocher cette case pour la réactiver.';
...
$string['slide1info_desc'] = 'Détails de la diapositive 1.';
$string['slide2info'] = 'Diapositive 2';
$string['slide2info_desc'] = 'Détails de la diapositive 2.';
$string['slide3info'] = 'Diapositive 3';
$string['slide3info_desc'] = 'Détails de la diapositive 3.';
...
$string['sliderinfo_desc'] = 'Ce bouton montrera/cachera une boîte à texte spéciale qui glisse vers le bas depuis la barre de navigation des icônes. C\'est idéal pour présenter des cours, offrir de l\'aide, ou lister les entraînements du personnel requis.';
...
$string['topnavbarbkg_desc'] = 'Couleur de fond de la barre de navigation';
...
$string['tumblr_desc'] = 'Saisir l\'URL de votre page tumblr (ex : http://www.tumblr.com/).';
$string['twitter'] = 'URL Twitter';
$string['twitter_desc'] = 'Saisir l\'URL de votre page Twitter (ex : http://www.twitter.com/).';
...
$string['vimeo_desc'] = 'Saisir l\'URL de votre chaîne Vimeo (ex : http://vimeo.com/).';
...
$string['layoutinfo_desc'] = 'Choisir des preset de design pour l\'agencement des pages.';
...
$string['flexsectionscollapse'] = 'Ouverture/fermeture des secitons';
$string['flexsectionscollapse_desc'] = 'Choisit le mode d\'ouverture/fermeture des sections';
$string['flexinitialstate'] = 'Etat initial des sections Flex';
$string['flexinitialstate_desc'] = '';
$string['collapsesingle'] = 'Fermeture individuelle';
$string['collapseaccordion'] = 'Mode accordéon';
