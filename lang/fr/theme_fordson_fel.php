...
$string['footerbg'] = 'Couleur d\'arrière-plan du pied de page';
$string['footerbg_desc'] = 'La couleur de fond du pied de page';
...
$string['fpiconnavbg'] = 'Couleur de l\'arrière-plan du bouton icône de la page d\'accueil';
$string['fpiconnavbg_desc'] = 'Couleur de l\'arrière-plan du bouton icône.';
...
$string['fploginformbg'] = 'Couleur du formulaire d\'enregistrement';
$string['fploginformbg_desc'] = 'Couleur d\'arrière-plan du formulaire de connexion sur la page d\'accueil personnalisée.';
...
$string['generalcontentinfodesc'] = 'Les options ci-dessous vous permettent de personnaliser la façon dont le contenu est affiché et d\'activer des fonctionnalités supplémentaires pour fordson_fel.';
...
$string['marketinginfodesc'] = 'Paramétrez les options des vos annonces de page d\'accueil. Vous devez avoir un titre pour que l\'annonce apparaisse. Les titres activent/désactivent les différentes annonces de la page d\'accueil.';
...
$string['sociallinkicondesc'] = 'Saisir le nom fontawesome de l\'icône pour votre lien<br />Une liste complète d\'icônes fontawesome peut être trouvé sur http://fontawesome.io/icons';
...
$string['topnavbarbghov'] = 'Couleur de fond de la barre de navigation en survol';
$string['topnavbarbghov_desc'] = 'Couleur de fond de la barre de navigation en survol';
