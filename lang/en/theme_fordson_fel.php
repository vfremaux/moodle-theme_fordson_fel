...
$string['presetaslast'] = 'Preset in last position';
$string['presetaslast_desc'] = 'If enabled, preset file will be appended after all scss sheets. Otherwise it comes as first tuning options.';
$string['comingfrom'] = 'Coming from: {$a}';
...
$string['drawerfg'] = 'Side Drawer foreground Colour';
$string['drawerfg_desc'] = 'Side Drawer foreground colour for the menu on the left side of the page.';
$string['cardbkg'] = 'Content Background Colour';
$string['cardbkg_desc'] = 'Content background colour for course content and blocks.';
$string['cardfg'] = 'Content foreground Colour';
$string['cardfg_desc'] = 'Content foreground colour for course content and blocks.';
$string['bodybkg'] = 'Body Background Colour';
$string['bodybkg_desc'] = 'The main colour to use for the background.';
$string['topnavbarbkg'] = 'Top Navigation Navbar Default';
$string['topnavbarbkg_desc'] = 'Content background colour for the top navigation bar.';
$string['topnavbarteacherbkg'] = 'Top Navigation Navbar Teacher Role';
$string['topnavbarteacherbkg_desc'] = 'Content background colour for the top navigation bar when a user is a teacher.  This feature must be turned on in Menu Settings. Please see the navbarcolorswitch setting.';
...
$string['rawscss_desc'] = 'Use this field to provide SCSS code which will be injected at the end of the sbgtyle sheet.';
...
$string['loginhelpbutton_desc'] = 'Text for the login help button';
...
$string['brandorganization_desc'] = 'Organization name to appear in the footer.';
$string['brandwebsite'] = 'Organization Website';
$string['brandwebsite_desc'] = 'Website address to appear in footer for organization.';
$string['brandphone'] = 'Organization Phone';
$string['brandphone_desc'] = 'Phone number to appear in footer.';
$string['brandemail'] = 'Organization Email';
$string['brandemail_desc'] = 'Email address for organization that appears in footer.';
...
$string['vk_desc'] = 'Enter the URL of your Vkontakte page. (i.e http://www.vk.com/)';
...
$string['sociallinkicon_desc'] = 'Enter the fontawesome name of the icon for your link<br />A full list of FontAwesome icons can be found at http://fontawesome.io/icons/';
...
$string['generalcontentinfo_desc'] = 'The options below help you customize the way content is displayed and turn on additional features for fordson_fel.';
...
$string['reset'] = 'Map';
$string['map'] = 'Map';
$string['flexsectionscollapse'] = 'Flex section collapsing';
$string['flexsectionscollapse_desc'] = 'Chooses mode for collapsing ';
...
$string['collapsesingle'] = 'Single section control';
$string['collapseaccordion'] = 'Accordion';
...
$string['footerfg_desc'] = 'Footer foreground';
